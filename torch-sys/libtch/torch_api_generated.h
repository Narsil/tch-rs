...
void atg__masked_softmax(tensor *, tensor self, tensor mask, int64_t dim_v, uint8_t dim_null);
...
void atg_random_from_functional(tensor *, tensor self, int64_t from, int64_t to_v, uint8_t to_null);
